...
\rev{In this study, we examine a different closed experiment whose phenotypic target and selection method --- reciprocal recurrent aelection --- closely mirrors methods used in the generation of modern maize hybrids \citep{comstock1949breeding, duvick2004long}. 
...
Beginning in cycle 10, the method of producing testcross progenies for evaluation was changed to generate a single set of reciprocal full sib families between the populations rather than two sets of half-sib families. \jri{i have commented out a couple lines i think are too much detail. uncomment them if you think they are worth including.} %Specifically, progeny rows resulting from self-pollination of individuals within each population were planted in a breeding nursery.  
