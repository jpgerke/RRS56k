...
\newcommand{\jpg}[1]{\textcolor{magenta}{ \emph{\scriptsize  #1}} }
\newcommand{\citex}[1]{\textcolor{red}{\bf #1}}
\newcommand{\blah}{\textcolor{red}{\bf blah}}
...
\response{PCA of just the founder lines does not show differentiation corresponding to the two populations. \jri{Justin, can you do this quick and dirty to confirm?}
\jpg{Yep, I did it a while back. I don't still have the plot but there was clear structure along that axis.}}
...
\jpg{I'm sure we can find them, just due to the size of the regions, but I don't think it would tell us much. I would be in favor of adding some more to the discussion about how the pressure for synchronous flowering time may have driven a lot of what we see. That said I could dig through Wallace et al. to see what is there.  Thoughts?}}
