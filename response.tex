...
\response{Heterozygosity plotted on a genetic map was shown in the original supplemental figure 2 (which the reviewer pointed out we failed to reference).  We have switched this figure for the original figure 2. As shown in the new figure 3, there are a few regions on chromosome arms that have been fixed and span multiple cM. \jri{do we need to note in the main text? an interesting observation, maybe implying rapid selection?}}
...
\response{\jri{Justin, any ideas? Do we do some formal correspondence with NAM results? }
\jpg{I'm sure we can find them, due to the size of the regions, but won't tell us much. I would be in favor of adding some more to the discussion about how pressure for synchronous flowering time may have driven a lot of what we see. But I could dig through Wallace et al. to see what is there.  Thoughts?}}
...
\response{We have added a paragraph in the introduction explaining the RRS method and populations in increased detail.\jri{this enough or do we add more elsewhere?}}
...
\response{We have noted in the new introductory paragraph that yield was the main focus of selection.\jri{add other phenotypes elsewhere?}}
...
\response{This was an oversight on our part; we have now incorporated citation to some of this literature and hopefully clarified the discussion.}

Finally, the Discussion seems a bit overly long and could potentially be more tightly written.

\response{We have endeavored to streamline the discussion where possible while incorporating additional citations (as above) and discussion of load as mentioend by reviewer 1.}
