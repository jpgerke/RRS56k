...
\begin{figure}[tb]   
  \begin{center}
   \includegraphics[width=\linewidth]{figs1_jri}
...
\begin{table}
\caption{Heterozygosity of SNPs in cycle 8 but not cycle 4 of the BSSS. \jri{are these numbers supposed to be the same? I checked the Pages doc and they are the same there too.}}
\begin{tabular}{  l | l | l | }
